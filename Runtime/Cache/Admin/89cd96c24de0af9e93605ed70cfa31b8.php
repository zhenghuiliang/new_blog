...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="<?php echo U('Admin/article/artadd');?>" enctype="multipart/form-data">  
      ...
      <div class="form-group">
        ...
        <div class="field">
          ...
          <script id="editor" type="text/plain" name="content" style="width:900px;height:400px;"></script>
          <div class="tips"></div>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="check_count" value="" data-validate="member:只能为数字"  />
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
