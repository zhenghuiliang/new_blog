...
<div class="error-container"> 
    <h1> 后台管理系统-信息提示 </h1>   
    <div class="errorcon">
    	<?php if($state == 1): ?><i class="icon-smile-o"></i>操作成功        
        <!-- <span style="display:none;"></span -->
        <?php else: ?>
        	<i class="icon-frown-o"></i><?php echo ($errorinfo); endif; ?>
   </div>
    <h4 class="smaller">页面自动 <a id="href" href="<?php echo ($url); ?>">跳转</a> 等待时间： <b id="wait"><?php echo($waitSecond); ?></b></h4> 
